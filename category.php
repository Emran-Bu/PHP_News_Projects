                  ...
                  <?php
                        ...
                        //   pagination php
                            ...
                            if (mysqli_num_rows($result1) > 0) {
                                ...
                                if ($page > 1) {
                                    echo "<li class=''><a href='category.php?cid={$cat_id}&page=" . ($page - 1) . "'>Prev</a></li>";
                                }
                                ...
                                for ($i = 1; $i <= $total_page; $i++) { 
                                    ...
                                    if ($page == $i or $i == $page - 1 or $i == $page + 1 or $i == 1 or $i == $total_page) {
                                        ...
                                        if ($i == 1) {
                                            ...
                                            echo "<li style='display:$displayFirst'><a class='btn disabled' href= 'category.php?cid={$cat_id}&page={$i}'>...</a></li>";
                                        ...
                                        if ($i == $total_page) {
                                            ...
                                            echo "<li style='display:$displayLast'><a class='btn disabled' href= 'category.php?cid={$cat_id}&page={$i}'>...</a></li>";
                                ...
                                if ($total_page > $page) {
                                    ...
                                    echo "<li class=''><a href='category.php?cid={$cat_id}&page=" . ($page + 1) . "'>Next</a></li>";
                                }
