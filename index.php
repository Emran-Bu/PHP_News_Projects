                                ...
                                for ($i = 1; $i <= $total_page; $i++) { 
                                    ...
                                    if ($page == $i or $i == $page - 1 or $i == $page + 1 or $i == 1 or $i == $total_page) {
                                        ...
                                        if ($i == 1) {
                                            ...
                                            echo "<li style='display:$displayFirst'><a class='btn disabled' href= 'index.php?page={$i}'>...</a></li>";
                                        ...
                                        if ($i == $total_page) {
                                            ...
                                            echo "<li style='display:$displayLast'><a class='btn disabled' href= 'index.php?page={$i}'>...</a></li>";
